    ...
    return (
      <React.Fragment>
        <div id="searchHeader">
          ...
          <p>Search for drinks based off either their name or ingredient.</p>
        </div>
        <div className="mt-d d-flex justify-content-center">
          <form className="cocktail-search">
            <div className="form-search">
              <input id="searchbar" placeholder="Search a cocktail by..." />
              <select id="dropdown" onChange={this.updateDropDown}>
                <option value="name">Name</option>
                <option value="i">Ingredient</option>
              </select>
            </div>
            <div className="btnrow">
              <button id="searchButton" onClick={this.searchFunction}>
                Search
              </button>
        ...
        {this.state.select !== "name" && (
          <SearchDrinkFilterModal data={drinks} user={this.props.user} />
        )}
        {this.state.select === "name" && (
